...
1. String de tamanho fixo  
2. String de tamanho variável   
3. Data  
4. Lista de valores com separador a definir  
5. Inteiro ou Float
...
Use fontes de bases de dados como o [Kaggle](https://www.kaggle.com/), ou outra que desejar, desde que cumpra os requisitos acima e seja de domínio público. Se tiver dúvida se determinada base de dados é válida, pergunte ao professor da disciplina.
...
A ordenação externa irá remover espaços em branco de registros atualizados e deletados. As operações de CRUD seguintes deverão ser realizadas no novo arquivo ordenado.
